# Simple NPM Troubleshooting Script for Windows
param(
    [switch]$DryRun,
    [switch]$CheckOnly,
...
if ($DryRun) {
    ...
    if ($LASTEXITCODE -eq 0) {
        ...
        Write-Host "  .\npm-fix-simple.ps1 -Strategy force" -ForegroundColor Yellow
        Write-Host "  .\npm-fix-simple.ps1 -Strategy legacy" -ForegroundColor Yellow
        Write-Host "  .\npm-fix-simple.ps1 -Strategy force-legacy" -ForegroundColor Yellow
        exit 1
    }
}
