...
const NewsCard: React.FC<Props> = ({
  ...
  return (
    <a
      ...
      className={`block bg-gray-900 border ${getSentimentColor()} rounded-lg overflow-hidden hover:border-blue-500 transition-all hover:shadow-lg`}
    >
      {image && (
      ...
      <div className="p-4">
        <h3 className="text-white font-bold line-clamp-2 mb-2">{title}</h3>
